...
)
{
    ...
    printf("[strm][%p] Server Sending data... %ld Bytes\n", Stream, SendBuffer->Length);
...
)
{
    ...
    // huajianwang: add one line for listen as 0.0.0.0
    Address.Ipv4.sin_addr.s_addr = htonl(INADDR_ANY); // Listen on all interfaces
